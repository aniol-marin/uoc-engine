...
CalCoreModel::~CalCoreModel()
{
  ...
  //Fixed memory leaks on load core animations
  /*for(size_t b=0;b<m_vectorCoreAnimation.size();++b) 
  {
	  //delete m_vectorCoreAnimation[b].m_ptr;
	  delete (m_vectorCoreAnimation[b].);
	  //unloadCoreAnimation(b);
  }*/
