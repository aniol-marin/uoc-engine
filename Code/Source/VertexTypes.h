...
#define UOC_VERTEX_TYPE_POSITION				0x01
#define UOC_VERTEX_TYPE_COLOR					0x02
#define UOC_VERTEX_TYPE_NORMAL					0x04
#define UOC_VERTEX_TYPE_BLEND_INDICES			0x08
#define UOC_VERTEX_TYPE_BLEND_WEIGHT			0x10
#define UOC_VERTEX_TYPE_TEXTURE1				0x20
#define UOC_VERTEX_TYPE_TEXTURE2				0x40
#define UOC_VERTEX_TYPE_POSITION4				0x80
...
//Position
#define IFDEF_CREATE_UOC_0_POSITION_VERTEX
#define IFDEF_CREATE_UOC_1_POSITION_VERTEX XMFLOAT3 Position;

#define IFDEF_CREATE_UOC_0_POSITION_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_POSITION_VERTEX_CTOR_PARAMETER XMFLOAT3 Position

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_POSITION 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_POSITION UOC_VERTEX_TYPE_POSITION
...
//Position 4
#define IFDEF_CREATE_UOC_0_POSITION4_VERTEX
#define IFDEF_CREATE_UOC_1_POSITION4_VERTEX XMFLOAT4 Position;

#define IFDEF_CREATE_UOC_0_POSITION4_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_POSITION4_VERTEX_CTOR_PARAMETER XMFLOAT4 Position

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_POSITION4 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_POSITION4 UOC_VERTEX_TYPE_POSITION4
...
//Normal
#define IFDEF_CREATE_UOC_0_NORMAL_VERTEX
#define IFDEF_CREATE_UOC_1_NORMAL_VERTEX XMFLOAT3 Normal;

#define IFDEF_CREATE_UOC_0_NORMAL_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_NORMAL_VERTEX_CTOR_PARAMETER , XMFLOAT3 Normal

#define IFDEF_CREATE_UOC_0_NORMAL_VERTEX_CTOR
#define IFDEF_CREATE_UOC_1_NORMAL_VERTEX_CTOR this->Normal=Normal;

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_NORMAL 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_NORMAL UOC_VERTEX_TYPE_NORMAL
...
//Weight and indices
#define IFDEF_CREATE_UOC_0_WEIGHT_INDICES_VERTEX
#define IFDEF_CREATE_UOC_1_WEIGHT_INDICES_VERTEX \
	XMFLOAT4		Weights; \
	XMFLOAT4 		Indices;

#define IFDEF_CREATE_UOC_0_WEIGHT_INDICES_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_WEIGHT_INDICES_VERTEX_CTOR_PARAMETER , XMFLOAT4 Weights, XMFLOAT4 Indices
#define IFDEF_CREATE_UOC_0_WEIGHT_INDICES_VERTEX_CTOR
#define IFDEF_CREATE_UOC_1_WEIGHT_INDICES_VERTEX_CTOR this->Weights=Weights; this->Indices=Indices;

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_WEIGHT_INDICES 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_WEIGHT_INDICES UOC_VERTEX_TYPE_BLEND_WEIGHT | UOC_VERTEX_TYPE_BLEND_INDICES
...
//Color
#define IFDEF_CREATE_UOC_0_COLOR_VERTEX
#define IFDEF_CREATE_UOC_1_COLOR_VERTEX XMFLOAT4 Color;

#define IFDEF_CREATE_UOC_0_COLOR_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_COLOR_VERTEX_CTOR_PARAMETER , XMFLOAT4 Color
#define IFDEF_CREATE_UOC_0_COLOR_VERTEX_CTOR
#define IFDEF_CREATE_UOC_1_COLOR_VERTEX_CTOR this->Color=Color;

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_COLOR 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_COLOR UOC_VERTEX_TYPE_COLOR
...
//UV
#define IFDEF_CREATE_UOC_0_UV_VERTEX
#define IFDEF_CREATE_UOC_1_UV_VERTEX XMFLOAT2		UV;

#define IFDEF_CREATE_UOC_0_UV_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_UV_VERTEX_CTOR_PARAMETER , XMFLOAT2 UV
#define IFDEF_CREATE_UOC_0_UV_VERTEX_CTOR
#define IFDEF_CREATE_UOC_1_UV_VERTEX_CTOR this->UV=UV;

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_UV 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_UV UOC_VERTEX_TYPE_TEXTURE1
...
//UV2
#define IFDEF_CREATE_UOC_0_UV2_VERTEX
#define IFDEF_CREATE_UOC_1_UV2_VERTEX XMFLOAT2		UV2;

#define IFDEF_CREATE_UOC_0_UV2_VERTEX_CTOR_PARAMETER
#define IFDEF_CREATE_UOC_1_UV2_VERTEX_CTOR_PARAMETER , XMFLOAT2 UV2
#define IFDEF_CREATE_UOC_0_UV2_VERTEX_CTOR
#define IFDEF_CREATE_UOC_1_UV2_VERTEX_CTOR this->UV2=UV2;

#define IFDEF_CREATE_GET_VERTEX_TYPE_0_UV2 0
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_UV2 UOC_VERTEX_TYPE_TEXTURE2
...
#define CREATE_UOCD3D11_VERTEX(StructName, HasPosition, HasPosition4, HasNormal, HasWeightIndices, HasColor, HasUV, HasUV2) \
class StructName \
{ \
public: \
	IFDEF_CREATE_UOC_##HasPosition##_POSITION_VERTEX; \
	IFDEF_CREATE_UOC_##HasPosition4##_POSITION4_VERTEX; \
	IFDEF_CREATE_UOC_##HasWeightIndices##_WEIGHT_INDICES_VERTEX; \
	IFDEF_CREATE_UOC_##HasNormal##_NORMAL_VERTEX; \
	IFDEF_CREATE_UOC_##HasColor##_COLOR_VERTEX; \
	IFDEF_CREATE_UOC_##HasUV##_UV_VERTEX; \
	IFDEF_CREATE_UOC_##HasUV2##_UV2_VERTEX; \
\
	StructName() \
	{ \
	} \
	StructName(IFDEF_CREATE_UOC_##HasPosition##_POSITION_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasPosition4##_POSITION4_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasWeightIndices##_WEIGHT_INDICES_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasNormal##_NORMAL_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasColor##_COLOR_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasUV##_UV_VERTEX_CTOR_PARAMETER IFDEF_CREATE_UOC_##HasUV2##_UV2_VERTEX_CTOR_PARAMETER) \
	{ \
		this->Position=Position; \
		IFDEF_CREATE_UOC_##HasNormal##_NORMAL_VERTEX_CTOR \
		IFDEF_CREATE_UOC_##HasWeightIndices##_WEIGHT_INDICES_VERTEX_CTOR \
		IFDEF_CREATE_UOC_##HasColor##_COLOR_VERTEX_CTOR \
		IFDEF_CREATE_UOC_##HasUV##_UV_VERTEX_CTOR \
		IFDEF_CREATE_UOC_##HasUV2##_UV2_VERTEX_CTOR \
	} \
...
CREATE_UOCD3D11_VERTEX(UOC_POSITION_WEIGHT_INDICES_NORMAL_TEXTURE_VERTEX, 1, 0, 1, 1, 0, 1, 0);
CREATE_UOCD3D11_VERTEX(UOC_POSITION_NORMAL_TEXTURE_VERTEX, 1, 0, 1, 0, 0, 1, 0);
CREATE_UOCD3D11_VERTEX(UOC_POSITION4_COLOR_TEXTURE_VERTEX, 0, 1, 0, 0, 1, 1, 0);
CREATE_UOCD3D11_VERTEX(UOC_POSITION_COLOR_VERTEX, 1, 0, 0, 0, 1, 0, 0);
CREATE_UOCD3D11_VERTEX(UOC_POSITION_TEXTURE_VERTEX, 1, 0, 0, 0, 0, 1, 0);
CREATE_UOCD3D11_VERTEX(UOC_POSITION_COLOR_TEXTURE_VERTEX, 1, 0, 0, 0, 1, 1, 0);
